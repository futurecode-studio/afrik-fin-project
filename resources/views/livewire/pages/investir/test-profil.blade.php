<div class="bg-[#f9f9ff] text-[#131c2a] min-h-screen">
    ...
    <section class="px-5 lg:px-16 max-w-[720px] mx-auto pt-12 pb-20">
        <p class="text-sm font-semibold tracking-widest uppercase text-[#0a2e8c] mb-3">Questionnaire</p>
        <h1 class="text-3xl font-extrabold text-[#001a61]">Test profil investisseur</h1>
