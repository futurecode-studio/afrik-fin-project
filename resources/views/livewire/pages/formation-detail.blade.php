            ...
            <div class="rounded-lg border bg-card text-card-foreground shadow-sm p-8">
                <div class="flex flex-col lg:flex-row gap-8">
                    <div class="flex-1">
                        ...
                        <p class="text-lg text-muted-foreground mb-6">{{ $formation->description_courte }}</p>
                ...
                <div class="lg:col-span-2 space-y-12">
                    ...
                    <div>
                        ...
                        <div class="prose prose-lg max-w-none text-muted-foreground">
                            {!! nl2br(e($formation->description_complete)) !!}
                        </div>
                    </div>
                    @endif
        ...
        <div class="bg-white rounded-xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto" wire:click.stop>
            ...
            <div class="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between rounded-t-xl">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">{{ $formation->titre }}</p>
                </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-500">{{ $formation->duree }} • {{ $formation->modules->count() }} modules</p>
                        ...
                        <label class="relative cursor-pointer">
                            ...
                            <div class="border-2 rounded-lg p-4 text-center transition-all peer-checked:border-primary peer-checked:bg-primary/5 hover:border-gray-300">
                                <div class="w-10 h-10 mx-auto mb-2 bg-blue-100 rounded-full flex items-center justify-center">
                                    <span class="text-blue-600 font-bold text-sm">KK</span>
                                </div>
                        ...
                        <label class="relative cursor-pointer">
                            ...
                            <div class="border-2 rounded-lg p-4 text-center transition-all peer-checked:border-primary peer-checked:bg-primary/5 hover:border-gray-300">
                                <div class="w-10 h-10 mx-auto mb-2 bg-green-100 rounded-full flex items-center justify-center">
                                    <span class="text-green-600 font-bold text-sm">FP</span>
                                </div>
                ...
                <!-- Bouton de paiement -->
                <button wire:click="@if($formation->isFree()) enrollFree @else initiatePayment @endif" wire:loading.attr="disabled"
                    class="w-full bg-primary text-white font-semibold py-4 rounded-lg hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2">
