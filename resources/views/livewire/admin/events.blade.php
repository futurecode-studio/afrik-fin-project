...
@endpush
                            ...
                            <td class="p-4 text-right">
                                <div class="relative inline-block text-left" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" x-transition class="absolute right-0 z-50 mt-1 w-48 rounded-lg border border-border bg-card shadow-lg overflow-hidden" style="display: none;">
                                        <a href="{{ route('admin.event.registrations', $event) }}" class="block px-4 py-2 text-sm text-foreground hover:bg-muted transition-colors">
                                            <span class="inline-flex items-center gap-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                                                Inscrits
                                            </span>
                                        </a>
                                        <a href="{{ route('admin.event.checkin', $event) }}" class="block px-4 py-2 text-sm text-foreground hover:bg-muted transition-colors">
                                            <span class="inline-flex items-center gap-2">
