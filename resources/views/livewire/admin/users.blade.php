...
<div class="flex flex-wrap justify-between items-end gap-4 mb-2">
        <div>
            <nav class="flex items-center gap-2 text-[#757683] mb-2 text-xs font-semibold tracking-wider uppercase">
                ...
                <span class="text-[#001a61]">UTILISATEURS</span>
            </nav>
            <h2 class="text-3xl font-extrabold text-[#001a61] tracking-tight">Gestion des Utilisateurs</h2>
        </div>
    </div>
            ...
            <div class="flex flex-col space-y-1.5 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-[#757683]">{{ $users->total() }} utilisateur(s) enregistré(s)</p>
                    </div>
                    <button @click="open = true; $wire.openModal()" type="button"
                        class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 admin-btn-primary  h-11 px-6 py-3">
                    ...
                    <table class="admin-table w-full caption-bottom text-sm">
                        <thead class="[&_tr]:border-b">
                            <tr class="border-b transition-colors hover:bg-[#f0f3ff]">
                                ...
                                <th class="h-12 px-4 text-left align-middle font-medium text-[#757683]">Rôle</th>
                        ...
                        <tbody class="[&_tr:last-child]:border-0">
                            @forelse($users as $user)
                                <tr class="border-b transition-colors hover:bg-[#f0f3ff] {{ $user->trashed() ? 'opacity-50' : '' }}">
